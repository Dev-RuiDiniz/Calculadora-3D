...
# Constantes
SENHA_CORRETA = "1234"
CAMINHO_IMAGENS = os.path.join("assets", "images")
...
def criar_janela_principal():
    ...
    bg_image = Image.open(resource_path(CAMINHO_IMAGENS, "fundo.png"))
    ...
    logo_image = Image.open(resource_path(CAMINHO_IMAGENS, "logo.png"))
