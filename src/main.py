...
def resource_path(*relative_path):
    ...
    return os.path.join(base_path, *relative_path)  # Combina o caminho base com os argumentos passados
...
def criar_janela_principal():
    ...
    bg_image = Image.open(resource_path('assets', 'images', "fundo.png"))  # Caminho corrigido
    ...
    logo_image = Image.open(resource_path('assets', 'images', "logo.png"))  # Caminho corrigido
